        ...
        <div class="hy_list">
            ...
            <!--高级配置-->
                <ul class="hypz gjpz clearfix">
                     <li class="clearfix">
                         <input type="hidden" name="id" value="${ojbk.id}" >

                         <span class="title">部门名称：</span>
                        <div class="li_r">
                            <input class="chang" name="name" value="${ojbk.name}" type="text">
                            <i>*</i>
                        </div>
                    </li>
                    <li class="clearfix">
                        ...
                        <div class="li_r">
                            <input class="chang" name="address" value="${ojbk.address}" type="text">
                            <i>*</i>
                        </div>
                    </li>
