                ...
                <div class="xjhy">
                    ...
                    <ul class="hypz gjpz clearfix">
                        <li class="clearfix">
                            ...
                            <div class="li_r">${USER.username}</div>
                        </li>
                        <li class="clearfix">
                            <span class="title">状态：</span>
                            <div class="li_r">${USER.state}</div>
                        </li>
                        <li class="clearfix">
                        ...
                        <li class="clearfix">
                            ...
                            <div class="li_r">${USER.employeeName}</div>
                        </li>
                        <li class="clearfix">
                        ...
                        <li class="clearfix">
                            ...
                            <div class="li_r">
                                <fmt:formatDate value="${USER.bornTime}" pattern="yyyy-MM-dd"/>
                            </div>
                        </li>
                        <li class="clearfix">
